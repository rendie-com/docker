...
(async () => {
  ...
  const browser = await launch({
    ...
    headless: 'new',//'new':表示后台运行   //false:表示打开窗口  
  });
  ////////////////////////////////////////
  ...
  await page.evaluate(() => {
    ...
    localStorage.setItem("menuList", '{"top1":1,"top2":{"18":{"name":"任务","id":"18","isbool":true,"url":"https://www.rendie.com/view/Default/admin/html/Shopee/%E4%BB%BB%E5%8A%A1.html?jsFile=js02&return=%2Fview%2FDefault%2Fadmin%2Fhtml%2FShopee%2F%25E4%25BB%25BB%25E5%258A%25A1.html%3FjsFile%3Djs04"}}}');
  });
  /////////////////////////////////// 
  let count = 0;
  let Enable = true;
